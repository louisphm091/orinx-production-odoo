# fashion_forecast/models/fashion_forecast_line.py
from odoo import api, fields, models


class FashionForecastLine(models.Model):
    _name = "fashion.forecast.line"
    _description = "Fashion Forecast Line"
    _order = "forecast_qty desc, id desc"

    forecast_id = fields.Many2one("fashion.forecast", required=True, ondelete="cascade")
